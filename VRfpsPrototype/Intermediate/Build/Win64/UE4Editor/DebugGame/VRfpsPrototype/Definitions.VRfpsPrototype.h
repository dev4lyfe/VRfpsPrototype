...
#define ORIGINAL_FILE_NAME "UE4Editor-VRfpsPrototype-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME VRfpsPrototype
#define DEPRECATED_FORGAME DEPRECATED
#define VRFPSPROTOTYPE_API DLLEXPORT
